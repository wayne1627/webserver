...
void threadpool< T >::run() {
    ...
    while (!m_stop) {
        ...
        connectionRAII mysqlcon(&request->mysql, m_connPool); // one class get out of his domain will call destroy function
        request->process(); // process includes read_process & write_process
    }
